...
namespace LawTrack.Controllers
{
	public class UsersController : Controller
	{
		...
		public UsersController(LawTrackDbContext dbContext, ILogger<UsersController> logger)
		{
		...
		[HttpPost]
		public IActionResult SaveUser(int ID, string Username, string FirstName, string LastName, string Email, int RoleID, string UserTypeID, string StatusID)
		{
			...
			try
			{
				...
				if (ID != 0)
				{
					...
					existingUser.Email = normalizedEmail.Trim().ToLower();
					existingUser.RoleID = RoleID;
					existingUser.UserTypeID = UserTypeID;
					existingUser.StatusID = StatusID;
					existingUser.UpdatedUserID = string.IsNullOrEmpty(UserId) ? null : Convert.ToInt32(UserId);
				...
				else // ✅ New User
				{
					...
					var newUser = new User
					{
						...
						Password = "58d562cdb5cf291dcc96934b95da27929819e896be1b9794d02627e0927916c9",
						Email = normalizedEmail.Trim().ToLower(),
		...
		public IActionResult DeleteUser(int ID)
		{
			...
			try
			{
				...
				user.DeletedUserID = string.IsNullOrEmpty(UserId) ? null : Convert.ToInt32(UserId);
			...
			catch (Exception ex)
			{
				...
				{
					success = false,
					message = $"An unexpected error occurred while deleting user {user.Username}!"
				});
			}
		}
		...
		public IActionResult ResetPassword(int id)
		{
			try
			{
				...
				user.Password = "58d562cdb5cf291dcc96934b95da27929819e896be1b9794d02627e0927916c9"; // ⚠️ For testing only
				user.UpdatedUserID = string.IsNullOrEmpty(UserId) ? null : Convert.ToInt32(UserId);
